...
const AddProduit = () => {
    ...
    const [numPrd, setNumPrd] = useState('')
    ...
    const saveOrUpdateProduit = (e) => {
        ...
        const produit = { numPrd, nomPrd, categorie, titre, descCourte, descLong }
    ...
    useEffect(() => {
        ...
        ProduitsService.getProduitById(id).then((response) => {
            setNumPrd(response.data.numPrd)
                        ...
                        <div className="form">
                                ...
                                <div className="inputfield">
                                    ...
                                    <input
                                        ...
                                        value={numPrd}
                                        onChange={(e) => setNumPrd(e.target.value)}
                                    >
                                    </input>
                                </div>
