          ...
          <Row style={{ marginTop: "20px" }}>
            <Col sm="12" md={{ size: 3, offset: 4 }}>
              <Form onSubmit={this.doActive}>
                <FormGroup>
                  <Label for="code"><br></br><br></br><strong>S'il vous plait activer votre compte via un code se trouve dans votre boite e-mail<div>{this.state.mail}</div></strong></Label>
                  <br></br><br></br>
                  <Input type="code"
                    name="code" id="code"
