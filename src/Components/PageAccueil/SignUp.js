  ...
  changeHandler = (event) => {
    ...
    switch (name) {
      case 'prenom':
        errors.prenom =
          value.length < 3
            ? 'Prenom doit contenir 3 caractères !'
            : '';
        break;
      case 'lastname':
        errors.nom =
          value.length < 3
            ? 'nom doit contenir 3 caractères !'
            : '';
        break;
      case 'username':
        errors.username =
          value.length < 5
            ? 'nom utilisateur doit contenir 3 caractères !'
            : '';
        break;
      case 'datenaissance':
        errors.datenaissance =
          value.length < 6
            ? 'datenaissance doit contenir 6 caractères !'
            : '';
        break;
      case 'codepostal':
        errors.codepostal =
          value.length < 4
            ? 'codepostal doit contenir 4 caractères !'
            : '';
        break;
      case 'telephone':
        errors.telephone =
          value.length < 8
            ? 'telephone doit contenir 8 caractères !'
            : '';
        break;
      case 'ville':
        errors.ville =
          value.length < 4
            ? 'ville doit contenir 4 caractères !'
            : '';
        break;
      ...
      case 'password':
        errors.password =
          value.length < 8
            ? 'motdepasse doit contenir 3 caractères !'
            : '';
        break;
      default:
        break;
            ...
            <Form onSubmit={this.signUp}>
             <FormGroup controlId="forFirstname">
              ...
              <FormGroup controlId="forcodepostal">
                <Label for="datenaissance">Code postal</Label>
                <Input
                  type="text" 
